...
- [x] React Router v6 설정 (`src/router.tsx`)
...
### 📱 페이지 구현
- [x] `pages/Landing` — uiux 1: 메인 타이틀 + CTA 버튼
- [x] `pages/ZodiacSelect` — uiux 2: 12개 별자리 선택 그리드
- [x] `pages/FortuneLoading` — uiux 3: 로딩 스피너 + 텍스트
- [x] `pages/FortuneResult` — uiux 6/7: 총운 결과 + FortuneCircle 3개
- [x] `pages/LuckyElements` — uiux 8/9/10: 장소/행동/색상 카드
- [x] `pages/FlowerLoading` — uiux 11~14: 꽃 개화 애니메이션 로딩
- [x] `pages/FlowerResult` — uiux 15: 꽃 추천 결과 + 꽃말/행운/장소
- [x] `pages/FlowerPrint` — uiux 16: 인쇄용 출력 카드

### 🧩 도메인 컴포넌트
- [x] `components/FortuneCircle` — 원형 게이지 (타입: 관계운/금전운/업무운, 수치: 0~100)
